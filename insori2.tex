...
Das \textit{Technology Acceptance Model} \cite{Zitat01}, kurz TAM, ist ein von Davis entwickeltes Akzeptanzmodell, welches auf dem sozialpsychologischem Modell \textit{Theory of Reasond Action} (TRA) von Ajzen und Fishbein \cite{Zitat04} basiert. Es versucht Aussagen darüber treffen zu können warum eine Technologie von einer Person akzeptiert wird oder nicht. \\
